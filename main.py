...
class User:
  ...
  def view(self):
    ...
    for i in range(len(self.tasks)):
      tasks+= 'Task '+ str(i+1) + ' ' + self.tasks[i] + '\n'
    return tasks
...
breakList = ["You can take a break now!", "You are a machine! Good job working through the time.","Take a break!", "Congratulations, you made it through!"] 
...
async def bothelp(ctx):
  embed=discord.Embed(title="Commands", color=discord.Colour.from_rgb(255, 192, 203))
  embed.add_field(name="Timer", value="**setup** [no parameters] *must be done once added to server* \n**start** [no parameters] \n**set** [work time (in minutes)] [break time (in minutes)] [number of cycles]",  inline=True)
  embed.add_field(name="Tasks", value="**view** [no parameters] \n**add** [name of task] \n**remove** [name of task]")
